	...
	<div class="relative px-6 pt-24 pb-8">
		<div class="mx-auto max-w-2xl py-32">
			<div class="text-center">
				...
				<p class="mt-6 text-lg leading-8 text-gray-700">Crie seus modelos de banco de dados de forma simples e rápida. Com o <abbr title="BR Moldelo Web" class="inline-block border-2 border-teal-800 rounded px-1 text-sm font-semibold text-teal-800 no-underline cursor-help">BRMW</abbr> você pode criar, editar e exportar SQL direto do seu navegador.</p>
